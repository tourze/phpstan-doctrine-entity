...
use Tourze\PHPStanDoctrineEntity\IndexNamePrefixRule;

/**
 * @extends RuleTestCase<IndexNamePrefixRule>
 * @internal
 */
#[CoversClass(IndexNamePrefixRule::class)]
final class IndexNamePrefixRuleTest extends RuleTestCase
{
    ...
    {
        return new IndexNamePrefixRule();
    }
}
